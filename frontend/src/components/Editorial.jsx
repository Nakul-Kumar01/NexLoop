...
const Editorial = ({ secureUrl, thumbnailUrl, duration }) => {
  ...
  useEffect(() => {
    ...
    if (video) {
      video.addEventListener('timeupdate', handleTimeUpdate); // continuously update current time
  ...
  return (
    ...
    >
      {/* Video Element */}
      <video
        ref={videoRef}  // refference hook mei ye element store krr doo 
        src={secureUrl}  // vdo kha present hai
        poster={thumbnailUrl}
