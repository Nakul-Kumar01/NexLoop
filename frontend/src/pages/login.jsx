        ...
        <div className='max-w-screen w-full h-screen flex flex-col items-center justify-center  bg-gradient-to-b from-[#061021] via-[#071428] to-[#08122a] relative overflow-hidden'>
         ...
         A16 16 0 1 1 18 46"
                    ...
                    <div className="flex justify-center gap-4">
                        {/*you should NOT use axios for Google OAuth start,  bcoz OAuth does not work like a normal API call */}
                        <button onClick={() => window.open(`https://nexloop.onrender.com/user/google`, "_self")} type="button" className="btn btn-outline rounded-full hover:text-amber-500">
                            <svg
                                className="w-6 h-6"
                                viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg"
                        ...
                        <button onClick={() => window.open(`https://nexloop.onrender.com/user/github`, "_self")} type="button" className="btn btn-outline rounded-full hover:text-amber-500">
